...
export interface TemplateMethods {
   ...
   */
  firstWhere(
    inputCondition: ((data: Template) => boolean) | string
  ): FirstWhereMethods<Template>;
}
...
export interface DocumentMethods {
   ...
   */
  firstWhere(
    inputCondition: ((data: Document) => boolean) | string
  ): FirstWhereMethods<Document>;
}
...
export interface UserMethods {
   ...
   */
  firstWhere(
    inputCondition: ((data: User) => boolean) | string
  ): FirstWhereMethods<User>;
}
...
export interface BlockMethods {
   ...
   */
  firstWhere(
    inputCondition: ((data: Block) => boolean) | string
  ): FirstWhereMethods<Block>;
}
...
export interface OrganizationMethods {
   ...
   */
  firstWhere(
    inputCondition: ((data: Organization) => boolean) | string
  ): FirstWhereMethods<Organization>;
}

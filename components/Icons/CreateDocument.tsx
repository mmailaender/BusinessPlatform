const CreateDocument = () => {
  return (
    ...
    >
      <path
        d='M0.5 167V5C0.5 2.51472 2.51472 0.5 5 0.5H61H91.6056L121.5 28.2747V43V86V167C121.5 169.485 119.485 171.5 117 171.5H5C2.51472 171.5 0.5 169.485 0.5 167Z'
        fill='#F4F5F7'
        stroke='#DFE2EA'
      />
